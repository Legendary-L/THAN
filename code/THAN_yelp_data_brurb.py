...
# walk_L=24         #120/5 120步 5个节点一步
# walk_L=20         #100/5 100步 5个节点一步
# walk_L=12
Y_n=3

p_neigh_list_train = [[] for k in range(2614)]
author_paper = [[] for k in range(2614)]
# ../data/academic/
het_walk_f = open("../data/yelp/" + "brurb_F_T.txt", "r")
...
het_walk_f = open("../data/yelp/" + "yelp_data_brurb.txt", "w")
