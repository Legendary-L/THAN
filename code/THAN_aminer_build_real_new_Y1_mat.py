...
DataMat = []
het_walk_f = open("../data/aminer/oriData/" + "THAN_aminer_Y1.txt", "r")
# x=0
...
scipy.io.savemat('aminer1.mat',mdict = {'APA':APA,'APCPA':APCPA,'train_idx':train_idx,'val_idx':val_idx,'test_idx':test_idx,'feature':feature,'label':label})