...
DataMat = []
het_walk_f = open("../data/yelp/" + "X_brurb_3.txt", "r")
...
het_walk_f = open("../data/yelp/" + "X_bsb_3.txt", "r")
for line in het_walk_f:
    curLine = line.strip().split(" ")
    DataMat.append(curLine)
    line_id = 0
...
scipy.io.savemat('yelp3.mat',mdict = {'BRURB':BRURB,'BSB':BSB,'train_idx':train_idx,'val_idx':val_idx,'test_idx':test_idx,'feature':feature,'label':label})
